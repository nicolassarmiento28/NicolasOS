...
- Cada proyecto debe mostrar un link funcional a su demo (`Project.url`),
  no solo el nombre y el stack — ver dirección de arte completa de esta
  vista en `10-diseno-visual.md`.
...
que recién se ejecuta en el cliente. Cada proyecto tiene un link visible y
funcional a su demo.
